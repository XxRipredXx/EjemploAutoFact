...
<html>
    ...
    <br>
        <div class="form-element col-sm-4"><br>
            <label>¿Qué Te gustaria que le agregaramos al informe?</label>
            <textarea name="resp_1" rows="5" cols="2" class="form-control" required> </textarea>
        </div>
        <div class="form-element col-sm-3"><br>
            <label>¿La informacion es correcta?</label>
            <select name="resp_2" class="form-control col-sm-4">
        ...
        <div class="form-element col-sm-2">
            <input type="radio" id="1" name="opcion" value="1" required>
        ...
        <button type="submit" name="formulario" value="formulario" class="btn btn-primary">Enviar</button>
    ...
    if (isset($_POST['formulario'])) {
        ...
        if ($result) {
            ...
            $logmessage =  '[' . date('Y-m-d h:i:s') .' . "Usuario: " .  '.$usuario_id.'] '. "Error de envio de formulario" . "\n";
